...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/ruby/projects/PinkPick/public/storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/ruby/projects/PinkPick/public/storage','logging.default',
...
'sanctum.csrf-cookie',
'shop','products.show','dashboard','cart.page','cart.items.index',
'cart.items.store','cart.items.update','cart.items.destroy','profile.edit','profile.update',
'profile.destroy','checkout.page','orders.store','orders.success','member.orders',
'member.orders.show','admin.orders.index','admin.orders.update_status','admin.products.index','admin.products.store',
'admin.products.update','admin.products.destroy','register','login','password.request','password.email','password.reset','password.store',
